...
namespace Server.Models
{
    ...
    public class TicketTrafficLight : ITicketResponse
    {
        [Key]
        ...
        public TicketResponse ToResponse(PostgreDataBase db)
        {
            ...
            traffic_light = db.traffic_lights
                .Where(t => t.id == traffic_light_id).FirstOrDefault(); 
            traffic_light.district = db.districts
                .Where(t => t.id == traffic_light.district_id).FirstOrDefault(); 
